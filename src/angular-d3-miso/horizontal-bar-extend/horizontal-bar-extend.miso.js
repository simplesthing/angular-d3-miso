...
d3.chart('HorizontalBar').extend('HorizontalBarExtend', {
   initialize: function(config){
    ...
    function barsEnter(){
      this.attr('transform', function(d, i){ return 'translate(20,'+ chart.y(i) +')'; });
    }
    ...
    function outerLabelsEnter() {
      this.attr('transform', function(d,i) { return 'translate('+ (chart.positionInnerLabel(d) + 50 ) +',' + chart.y(i) + ')'; });
    }
